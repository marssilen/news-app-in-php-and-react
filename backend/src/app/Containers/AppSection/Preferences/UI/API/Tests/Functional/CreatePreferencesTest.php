...
/**
 * Class CreatePreferencesTest.
 *
 * @group preferences
 * @group api
 */
class CreatePreferencesTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/preferences';
    ...
    // TODO TEST
//    public function testCreatePreferencesWithInvalidFields(): void
//    {
//        $data = [
...
//    public function testGivenHaveNoAccess_CannotCreatePreferences(): void
//    {
